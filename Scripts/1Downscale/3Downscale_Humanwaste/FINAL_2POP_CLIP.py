...
###################################################################################
#Clip Raster based on the county boundary
###################################################################################
'''
#Input dataset:
...
#Processes:
#(1). Convert .adf to .tif and change crs to "EPSG:5070" for consistence
...
input_path ='./Data/POP/Jawitz_decadal_tiff/pop_m3_{}_5070.tif'
output_path ="./Data/POP/Clip_to_trend_extent/pop_m3_{}_5070_clipped.tif"
mask_path = "./Data/COUNTY/US_county.gpkg"
