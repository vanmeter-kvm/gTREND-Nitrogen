...
###################################################################################
#Convert population data to .tif in EPSG:5070
###################################################################################
'''
#Input dataset:
...
input_path = './Data/POP/USA_HistoricalPopulationDataset/pop_m3_{}/w001001.adf'
output_path = './Data/POP/Jawitz_decadal_tiff/pop_m3_{}_5070.tif'
resolution = 1000
